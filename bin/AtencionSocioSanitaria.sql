...
--
-- Host: db
-- Generation Time: Jan 27, 2025 at 08:22 AM
...
--
-- Database: `AtencionSocioSanitaria`
--
...
CREATE TABLE `Empleado` (
  ...
  `roles` enum('admin','user','guest') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
('rafnavgom', '1234567', 'Rafael', 'Navarro', 'rafnavgom@telejaca.com', 'admin');
...
(2, 1, 'rafnavgom', '2025-01-27', 1, 'momento incomodo ');
...
--
-- Table structure for table `Tipos_Llamada`
--
...
--
-- Dumping data for table `Tipos_Llamada`
--
...
--
-- Indexes for table `Tipos_Llamada`
--
...
--
-- AUTO_INCREMENT for table `Tipos_Llamada`
--
ALTER TABLE `Tipos_Llamada`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- Constraints for table `Cuidadores`
--
ALTER TABLE `Cuidadores`
